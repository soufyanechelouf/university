             ...
             <div class="col-xs-12 content">
                    ...
                    <ul class="list-unstyled text-center list">
                      ...
                      <li class="info">
                        <ul class="list-unstyled">
                          ...
                          <li><a href="etude.php?type=<?php echo $type ?>}&module=POO">POO</a></li>
                ...
                <div class="col-md-10 contenue">
                 <div class="col-md-12 title text-center">
                   <h2>Recherche : <?php echo $needle; ?></h2>
                 ...
                 <div class="col-md-12 fichiers">
                     <?php 
                     $i = 0;
                     foreach (serching('study', $level, 'Name', 'Description', $needle) as $row) { 
                     $i = $i + 1;
                      ?>
                     <div class="col-md-6">
                       <h4 class="text-primary"><?php echo $row['Name'] ?></h4><hr>
                       <span><?php echo $row['Type'] . " de " . $row['Module'] ?></span>
                       <i class="fa fa-file-pdf-o"></i>
                       <p class="lead"><?php echo $row['Description'] ?></p>
                       <strong>Ajoutée  : </strong><span><?php echo get($row['Date']); ?></span>
                       <span><a href="donwload.php?id=<?php echo $row['StudyId'] ?>">Donwload</a></span>
                       <i class="fa fa-download"></i> </a>                     
                     </div>
                     <?php }
                     if ($i == '0'){ ?>
                     <div class="alert alert-info" style="width: 113%; font-weight: bold;">Désolé,  auncune resultat est trouvée!</div>
                     <?php } ?>
                 </div>
                 <?php } ?>
              </div>
